...
class FavoriteViewController : BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.font: ConstantFont.bd14!]
...
extension FavoriteViewController : UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.productNameLabel.setLineSpacing(spacing: 2)
        
        //가게명
        cell.storeNameLabel.text = data.storeName
        cell.storeNameLabel.setLineSpacing(spacing: 24)
